...
//JUnit5-tests for class "TransistorEntity":

public class TransistorEntityTest {
	
   //Class to test.
   private Class cls = TransistorEntity.class;
    
    //Fields of testing class.
    final private static String[] fields = new String[] {"id", "category", "name", "description", "producer", "conductanceType", "gain", "maxCurrent", "maxCurrentUnit", "tPackage", "photo", "price", "quantity"};
	
	 //Getters of testing class.
	 final private static String[] getters = new String[] {"getId", "getCategory", "getName", "getDescription", "getProducer", "getConductanceType", "getGain", "getMaxCurrent", "getMaxCurrentUnit", "gettPackage", "getPhoto", "getPrice", "getQuantity"};	
     ...
     public void tableNameTest() {
       ...
       final String TABLE_NAME = "transistor";
     ...
     public void columnNameTest() {      	      	    
	    ...
	    String[] columnNames = new String[] {"transistor_id", "category", "name", "description", "producer", "conductunce_type", "gain", "max_current", "max_current_unit", "package", "photo", "price", "quantity"};	      
