 ...
 */  
     ...
     CategoryEntity categoryEntity1 = new CategoryEntity(1L, "locale.resistorCategoryName");
 //    CategoryEntity categoryEntity2 = new CategoryEntity(2L, "locale.transistorCategoryName");    
